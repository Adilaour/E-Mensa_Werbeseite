        ...
        <table id="koestlichkeitent">
            ...
            while($row = mysqli_fetch_assoc($result)) {
                if($row['Gerichtbild'] == null){
                    ...
                    echo '<tr><td><img src="img/gerichte/' . $row['Gerichtbild']. '" alt="Bild der Speise" style="height:75px; width:75px;">' . '</td><td class="alignleft">' . $row['Gerichtname'] . " <span style='font-size:0.75em'>" . $row['Allergen'] . '</span></td><td>' . $row['preisintern'] . '</td><td>' . $row['preisextern'] . '</td></tr>';
                    $gerichtanzahl++;
                }
